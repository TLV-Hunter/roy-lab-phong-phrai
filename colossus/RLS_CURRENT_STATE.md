...
- RLS-002 Still — PUBLISHED / confirmed by TalentVee as posted Sep07 night

Not published unless separately confirmed:
- RLS-002 Reel — NOT PUBLISHED
- RLS-003 and later episodes — NOT PUBLISHED

Never mark planned or ready assets as published without confirmed publication.

## FINAL REEL HARD RULE — LOCKED 2026-09-08
- Every RLS Final Reel must be at least 11.00 seconds.
- Under 11.00s = QA FAIL / REVISE.
- No long freeze, black frame, repeated action loop, dead padding, or deceptive duration extension.
- Preserve source action first; restrained timing stretch is allowed only when Natural Motion remains believable.
- Dola AI / third-party generation watermark must be absent from Final output.
- Watermark QA includes zoomed inspection across multiple timestamps.
...
- Current upscale path: Lanczos 720×1280 → 1080×1920.
- Do not label current output as AI upscale or true 4K.
